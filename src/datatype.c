...
JL_DLLEXPORT jl_value_t *jl_typemax_uint(jl_datatype_t *bt)
{
    ...
    if (bt->smalltag)
        jl_set_typetagof(v, bt->smalltag, GC_OLD_MARKED);
...
// some shims to support BOX_FUNC definition
#define jl_voidpointer_tag (((uintptr_t)jl_voidpointer_type) >> 4)
#define jl_uint8pointer_tag (((uintptr_t)jl_uint8pointer_type) >> 4)
